...
const AddLiquidity = () => {
  ...
  const setTokenInfo = useCallback(
    async (pairAddress) => {
      ...
      try {
        ...
        toast.error(getErrorMessage(error, "Cannot fetch token information for the pair!"), {
          toastId: "PAIR_0",
        });
        console.error(error);
      }
  ...
  return active ? (
    <Grid container>
      <Grid item>
        ...
        {tokensSelected ? (
          <Grid container columnSpacing={2}>
            <Grid item md={4}>
              <Grid container direction="column" alignItems="center">
                <Grid item>
                  <Typography>{getPrice(indexTokenB)}</Typography>
                </Grid>
                <Grid item>
                  <Typography>
            ...
            <Grid item md={4}>
              <Grid container direction="column" alignItems="center">
                <Grid item>
                  <Typography>{getPrice(indexTokenA)}</Typography>
                </Grid>
                <Grid item>
                  <Typography>
            ...
            <Grid item md={4}>
              <Grid container direction="column" alignItems="center">
                <Grid item>
                  <Typography>{getSharePercent()} %</Typography>
                </Grid>
                <Grid item>
          ...
          <Typography>No information! Please select a pair of tokens.</Typography>
        )}
        {tokensSelected && (
    ...
    <Typography>Please connect to a wallet to add liquidity</Typography>
  );
};
