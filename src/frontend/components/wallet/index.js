...
export const ETHEREUME_NETWORK_ID = 1;
export const SEPOLIA_NETWORK_ID = 11155111;
export const LOCAL_NETWORK_ID = 31337;

export const injectedConnector = new InjectedConnector({
  supportedChainIds: [ETHEREUME_NETWORK_ID, SEPOLIA_NETWORK_ID, LOCAL_NETWORK_ID],
});
export const walletConnectConnector = new WalletConnectConnector({
  rpc: {
    [SEPOLIA_NETWORK_ID]: process.env.REACT_APP_LOCAL_RPC_URL,
  },
  qrcode: true,
});
