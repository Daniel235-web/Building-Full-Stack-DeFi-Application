...
import {AppBar, Box, Divider, Drawer, IconButton, List, ListItem, ListItemButton, ListItemText, 
 Toolbar,  Typography,Button, Grid, useTheme, Tooltip, Menu, MenuItem}from '@mui/material';
        ...
        <AppBar component="nav">
            <Toolbar>
                ...
                <Box sx={theme.layout.menuBar}>
                    {navItems.map((item) => (
                        <Button key={item} sx={theme.components.menuButton} component={Link} to={item.link}>
                            {item.title}
                ...
                <Box>{active ?
                 ...
                 :<PopupState variant="popover" popupId="popup-select-connector">
                    {popupState => <React.Fragment>
                        <Tooltip title="select one type of wallet to start connecting your wallet">

                            <Button variant="contained" {...bindTrigger(popupState)}>Wallet Connectors</Button>
                        </Tooltip>
                        <Menu {...bindMenu(popupState)}>
                            <MenuItem onClick={() =>{ connect(injectedConnector); popupState.close()} }>Inject</MenuItem>  
